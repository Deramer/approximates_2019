...
$$
E_{vac}=\frac{\hslash c}{2}2\int_0^{\infty}\frac{n\pi}{a}f(n)dn
$$
...
$$
Здесь $B_{2k}$ - числа Бернулли. В частности, $B_2=\frac{1}{6}$, $B_4=-\frac{1}{30}$. Из физических предположений разумно потребовать, чтобы $f(0)=0$, $f^{'}(0)=f^{''}(0)=...=0$. Тогда получаем:
$$
...
$$
\Delta E=-\frac{1}{2}\frac{\pi\hslash c}{a}
$$
