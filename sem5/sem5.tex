...
$$
\int_{c}^{d}g(t)e^{i\lambda t^2}dt\approx g(0)\frac{1}{2}\sqrt{\frac{\pi}{2\lambda}}e^{i\pi/4}
$$
...
$$
\int_{a}^{b}f(x)e^{i\lambda S(x)}dx=\frac{1}{2}f(x_0)\sqrt{\frac{2\pi}{\lambda S^{''}(x_0)}}e^{i\lambda S(x_0)}e^{i\pi/4}
$$
